...
public class TestBase {
    ...
    public void setUp(){
        ...
        driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);//defaultnoe ojidanie elementa
        driver.manage().window().maximize();//na ves ekran

        openSite("https://trello.com");
        login("marina.yasina@gmail.com","SofiaAmalia2016");//Alt +Enter
   ...
   public void login(String email, String password) {
        new WebDriverWait(driver,15).until(ExpectedConditions.elementToBeClickable(By.cssSelector("[href='/login']")));//klass Seleniuma, ne vysko4it exeption. Driver,ty jdi 15 secund
        click(By.cssSelector("[href='/login']"));
       type(By.cssSelector("[type=email]"),email);
       type(By.cssSelector("[type=password]"),password);
       click(By.id("login"));
    }
//until- jdi Do togo momenta,poka  ojidaemyj element ne stanet clicabelnym-po locatoru
...
//
//    openSite("https://trello.com");
//    login("Shcherbakov-d@mail.ru", "wdw77wdw");
//  }
//
//  public void login(String email, String password) {
//    click(By.cssSelector("[href='/login']"));
